      ...
      <div className="space-y-5">
        ...
        <Card title={<span className="flex items-center gap-2"><Code2 size={16} style={{ color: "var(--accent)" }} /> Reusing the API in your own project</span>}>
          ...
          <ul className="mt-3 list-disc space-y-1.5 pl-5 text-[13px] leading-6 text-dim">
            <li>Every <code className="font-mono text-[12px]">GET</code> (health, analytics, scenarios, benchmarks) is always public. <code className="font-mono text-[12px]">POST</code> endpoints are only gated behind <code className="font-mono text-[12px]">X-VoiceFlow-Internal-Token</code> when the deployment sets <code className="font-mono text-[12px]">REQUIRE_INTERNAL_TOKEN=true</code> — off by default.</li>
