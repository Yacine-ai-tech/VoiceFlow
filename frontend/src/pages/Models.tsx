    ...
    <div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card hover>
          ...
          <div className="mt-3 space-y-2 text-[13px] leading-6 text-dim">
            ...
            <div><Chip>REMOTE</Chip> your own WhisperX+diarization endpoint (<code className="font-mono text-[11px]">VOICEFLOW_REMOTE_ENDPOINT</code>).</div>
            <div><Chip>LOCAL_WHISPERX</Chip> private on-host WhisperX; returns an explicit error when unavailable, never a silent guess.</div>
          </div>
        </Card>
        ...
        <Card hover>
          ...
          <div className="mt-3 space-y-2 text-[13px] leading-6 text-dim">
            ...
            <div><Chip>ELEVENLABS</Chip> premium quality + voice cloning.</div>
      ...
      <Card title="Named scenarios — for reproducible comparisons" className="mt-5">
        <p className="text-[13px] leading-6 text-dim">
          ...
          the one requested. See <code className="font-mono text-[12px]">GET /scenarios</code> for the full catalog.
        </p>
      </Card>
